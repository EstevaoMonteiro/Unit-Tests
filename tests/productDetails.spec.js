...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    expect(productDetails('Alcool gel', 'Máscara')[0].details.productId).toBe('Alcool gel123', 'Máscara123');
    expect(productDetails('Alcool gel', 'Máscara')[1].details.productId).toBe('Máscara123', 'Alcool gel123');
  });
});